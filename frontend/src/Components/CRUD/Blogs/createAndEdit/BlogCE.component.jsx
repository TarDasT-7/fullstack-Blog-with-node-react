...
import { find, store, update } from "../../../../Actions/Blog";
...
import { API, MAX_PHOTO_SIZE } from "../../../../config";
...
export const EditBlogComponent = () => {
    ...
    const formSubmitHandler = (e) => {
        ...
        update(slug, formData, token).then(data => {
            if (data.error) {
                console.log(data.error);
            } else {
                localStorage.removeItem('blog')
    ...
    return (
        <div className={classes.box}>
            <div className={classes.form_box}>
                <div className={classes.header_box}>
                    <div className={classes.title}>
                        <h1 > Update blog *{findBlog.title}* </h1>
                    </div>
                    <div className={classes.cancle}>
                        <Link onClick={cancleForm} to="/admin/blogs" > Cancle </Link>
                    </div>
                    ...
                    <form onSubmit={formSubmitHandler}>
                        ...
                        <div className={classes.form_input}>
                            <div className={classes.inp_regular}>
                                ...
                                {
                                    findBlog.photo ?
                                        <div className={classes.show_currentPhoto} onClick={() => {
                                            window.open(`${API}/blog/photo/${findBlog.slug}`,'_blank', 'rel=noopener noreferrer')
                                        }}>
                                            <span> Show Current photo </span>
                                        </div>
                                        : ''
                                }
                            ...
                            <button className={classes.sub_btn}>Update</button>
                        </div>
